...
@section('content')
    ...
    <div class="container page-headline">
        <h1>სართული {{$flor->flor_number}}</h1>
    </div>
    <!-- end page-header -->
    <form action="{{route('website.show.project', $flor->id)}}" method="GET">
        <section class="content-section ">
            <div class="">
                <!-- Button trigger modal -->
                <!-- Modal -->
                <div class="image_d">
                    <img src="/assets/image/{{ $flor->image }}" alt="">
                    {!! $flor->image_d !!}
                </div>
                <div class="container">
    ...
    <script>
        $("path").click(function() {
            $(location).prop('href', '/apartment/' + $(this).attr("id"))
        });
    </script>
