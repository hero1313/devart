...
@section('content')
    ...
    <div class="container page-headline">
        <h1>ბლოკი {{$corp->number}}</h1>
    </div>
    <!-- end page-header -->
    <form action="{{route('website.show.project', $corp->id)}}" method="GET">
        <section class="content-section ">
            <div class="">
                <!-- Button trigger modal -->
                <!-- Modal -->
                <div class="image_d">
                    <img src="/assets/image/{{ $corp->image }}" alt="">
                    {!! $corp->image_d !!}
                </div>
                <div class="container">
    ...
    <script>
        $("path").click(function() {
            $(location).prop('href', '/flor/' + $(this).attr("id"))
        });
    </script>
