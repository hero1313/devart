...
@section('content')
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <button type="button" class="btn btn-primary add-btn m-3" data-toggle="modal" data-target="#add_apartments">
                ბინის დამატება
            </button>
                            ...
                            <tr class="apartment-tr">
                                ...
                                <td>
                                    @if ($apartment->status == -1)
                                        <button class="btn-primary btn">თავისუფალი</button>
                                    @else
                                        <button class="btn-success btn">გაყიდული</button>
                                    @endif
                                </td>
                                <td>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('update.apartment-table', $apartment->id) }}" enctype='multipart/form-data' method="POST">
                                                @csrf
                                                @method('PUT')
                                                <select name="project_id" required class="form-select">
                                                    <option value="{{$apartment->project_id}}">{{$apartment->project_id}}</option>
                                                ...
                                                <div class="form-group mt-3">
                                                    ...
                                                    <input type="text" required name='corp_number' value="{{$apartment->corp_number}}" class="form-control mt-2">
                                                </div>
                                                <div class="form-group mt-3">
                                                    <label for="exampleInputEmail1">სართული</label>
                                                    <input type="text" required value="{{$apartment->flor}}" name='flor' class="form-control mt-2">
                                                </div>
                                                <div class="form-group mt-3">
                                                ...
                                                <div class="form-group mt-3">
                                                    ...
                                                    <input type="text" value="{{$apartment->code}}" name='code' class="form-control mt-2">
                                                </div>
                                                <div class="form-group mt-3">
    ...
    <div class="modal fade bd-example-modal-lg" id="add_apartments" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('store.apartment-table') }}" enctype='multipart/form-data'
                        method="POST">
                        @csrf
                        <select name="project_id" required class="form-select">
                            @foreach ($projects as $project)
                        ...
                        <div class="form-group mt-3">
                            <label for="exampleInputEmail1">კორპუსის ნომერი</label>
                            <input type="text" required name='corp_number' class="form-control mt-2">
                        </div>
                        <div class="form-group mt-3">
                            <label for="exampleInputEmail1">სართული</label>
                            <input type="text" required name='flor' class="form-control mt-2">
                        </div>
                        <div class="form-group mt-3">
                            <label for="exampleInputEmail1">ბინის ნომერი</label>
